package com.articles.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.articles.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException{
		...
		factoryBean.setPackagesToScan(new String[] {"com.articles.springboot.model"});
